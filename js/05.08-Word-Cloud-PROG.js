...
2.) Make it interactive for the user:
    - select menu lets use pick a passage
...
function makeWordCloud(passageStr, stopwords, wordCloud) {
    ...
    // how to convert this big ol' obj of word freq into DOM Word Cloud
    // loop the obj of min 5 words

    // return obj where all keys have val of 5+
    return passObjMin5;
